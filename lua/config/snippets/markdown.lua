...
local selected_lines = util.selected_lines
...
function M.snippets()
  ...
  return {
    ...
    s(
      with_condition({ trig = "td", name = "todo" }, conditions.with_line_begin(condition)),
...
---Return Obsidian callout snippets and callout cleanup helpers.
---@return SnipNode[]
function M.obsidian_snippets()
  local condition = conditions.text
  local callouts = {
    calln = "NOTE",
    calla = "ABSTRACT",
